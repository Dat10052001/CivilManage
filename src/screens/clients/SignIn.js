    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: '100vh' }} onClick={closeError}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://w.forfun.com/fetch/fa/fa0d84f2ade6c73cb6545cabace36fcf.jpeg)',
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
          ...
          >
            <Typography color='primary' variant="h3" sx={{mb: 10, fontWeight: 'bold', width: 600, textAlign: 'center'}}>
            ...
            <Typography sx={{fontSize: 15, mb: 5, color: '#1976d2', fontStyle: 'italic' }}>
              Phiên bản dành cho người thuê trọ
            </Typography>
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <Typography sx={{position: 'absolute', color: '#1976d2', fontSize: 16, right: 490, top: 535}}>
              <Checkbox sx={{mt: -0.5}} checked={showPassword} onChange={handleCheckboxChange}/>
                HIỆN MẬT KHẨU
              </Typography>
              <Grid item xs>
                  ...
                  <React.Fragment>
                        ...
                        <Dialog open={open1} onClose={handleClose1}>
                          ...
                          <DialogActions>
                            ...
                            <Button onClick={() => handlePhoneNumberValidation1(1)}>Gửi</Button> 
                          </DialogActions>
                        </Dialog>
                      </React.Fragment>
                  </Typography>
                ...
                <Grid item sx={{textAlign: 'center'}}> 
                  <Typography>
                    Nếu chưa có tài khoản ? Vui lòng
                      ...
                      <React.Fragment>
                        <Button variant="text" onClick={handleClickOpen} sx={{fontSize: 20, mt: -0.1}}>
                        ...
                        <Dialog open={open} onClose={handleClose}>
                          ...
                          <DialogActions>
                            ...
                            <Button onClick={() => handlePhoneNumberValidation(2)}>Gửi</Button>
                          </DialogActions>
                        </Dialog>
                      </React.Fragment>
                  </Typography>
